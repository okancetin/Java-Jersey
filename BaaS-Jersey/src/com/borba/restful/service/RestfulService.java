package com.borba.restful.service;
...
public class RestfulService {
	...
	// private static Map<String, Employee> employees = new HashMap<String,
	// Employee>();
	//
	// static {
	//
	...
	// @Produces("application/json")
	// public Employee getEmployeeJSON(@PathParam("employeeid") String
	// employeeId) {
	// return employees.get(employeeId);
	// }
